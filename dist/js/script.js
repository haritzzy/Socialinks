const getPhoto = document.getElementById('photo');
getPhoto.addEventListener('click', function(){
    getPhoto.requestFullscreen();
});
...
// const randomKehidupanQuote = getRandomQuote(quotesData.kehidupanQuotes);
// window.addEventListener('load', function(){
//     const getElemetQuote = document.getElementById('quote');
//     getElemetQuote.innerHTML = `"${randomKehidupanQuote}"`;
// });
